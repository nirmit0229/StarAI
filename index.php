...
<main>
  ...
  <!-- Site Hero Start -->
  <section class="site-hero" style="background-image: url('backgrounds/hero-background2.webp');">
    <div class="container">
      <div class="row">
            ...
            <ul class="site-hero-content-buttons">
              ...
              <li>
                <a href="research.php" class="btn btn-primary">
                  <span class="btn-area">
                    <span data-text="Astrology Research">
                      Astrology Research
                    </span>
                  </span>
                </a>
    ...
    <a href="#call-to-action" class="site-hero-scroll scroll-to">
