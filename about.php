      ...
      <div class="col-12">
        <div class="site-about-wrapper">
          <div class="site-about-company">
            <h1>
              STAR AI - A PARADIGM SHIFT IN ASTROLOGY
            </h1>
          </div>
          <div class="site-about-description">
            <p>
              We are a stealth mode startup on a mission to revolutionize the science and applications of astrology with the use of AI.
            </p>
            <br/>
            <p>
              Sign-up for a trial to be the first to hear about our upcoming products, and help advance astrology research by anonymously providing a few data points below.
            </p>
      ...
      <div class="row">
        <div class="col-12 text-center">
          ...
          <ul class="site-cta-buttons">
            <li>
              <a href="research.php?#begin" class="btn btn-primary">
                <span class="btn-area">
