...
<section class="site-contact">
    ...
    <div class="row">
      ...
      <div class="col-lg-6 ml-auto">
        <div class="site-contact-form">
          <h4>SIGN-UP AND BE THE FIRST TO TRY OUR PRODUCTS</h4>
          <form id="contact-form" action="https://formspree.io/f/xgepjopj" method="POST">
            <div class="row">
              <div class="col-lg-6">
                <input type="text" class="form-control" name="trial-first-name" id="trial-first-name" placeholder="First Name">
              </div>
              <div class="col-lg-6">
                <input type="text" class="form-control" name="trial-last-name" id="trial-last-name" placeholder="Last Name">
              </div>
              <div class="col-12">
                <input type="email" class="form-control" name="trial-email" id="trial-email" placeholder="Email">
              </div>
              <div class="col-12">
  ...
  <section class="site-cta" style='background-image: url("https://ecstatic-shannon-6103b9.netlify.app/backgrounds/cta-background.jpg");' id="call-to-action">
    <div class="container">
      <div class="row">
        <div class="col-12 text-center">
          <h1 class="site-cta-title">Astrology Research</h1>
          <p> Spend 3 minutes and help advance the science of astrology! Anonymously provide your birth details and a few life events to create and download a beautiful life map and enter a drawing to win a free session with our expert astrologer! </p>
          <br/>
          <ul class="site-cta-buttons">
            <li>
              <a href="/research/#begin" class="btn btn-primary">
                <span class="btn-area">
                  <span data-text="Begin">
                    Begin
                  </span>
                </span>
              </a>
