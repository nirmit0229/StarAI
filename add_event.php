...
<main>
  ...
  <p style="position: relative; margin-top: 100px; font-size: 22px; padding-left: 10px;">Use the menu to select the area of life, event type on the left, and specify details of the event on the right. After you enter your events you will be able to view and download your Life Timeline. Because we do not save any personally identifiable information, please click "Copy URL" to save the URL for your entry to be able to come back to view and edit your data in the future.</p>


  <script src="submit_add.js"></script>
  ...
  <form method="POST">
        ...
        <div class="radio_tabs">
          <label class="radio_wrap" data-radio="radio_1">
            <input name="areas" value="relationships" class="input" required style="cursor: pointer;">
          ...
          <label class="radio_wrap" data-radio="radio_2">
            <input  name="areas" class="input" value="health" required style="cursor: pointer;">
            <!-- <span class="radio_mark">
              --> Health
            <!-- </span> -->
          </label>
          ...
          <label class="radio_wrap" data-radio="radio_3">
            <input name="areas" class="input" value="financial" required>
<!--             <span class="radio_mark"> -->
              Financial
<!--             </span> -->
          </label>
          <label class="radio_wrap" data-radio="radio_4">
            <input name="areas" class="input" value="career" required>
         <!--    <span class="radio_mark"> -->
              Career
<!--             </span> -->
          </label>
          <label class="radio_wrap" data-radio="radio_5">
            <input name="areas" class="input" value="spiritual" required>
<!--             <span class="radio_mark"> -->
              Spiritual
<!--             </span> -->
          </label>
          ...
          <label class="radio_wrap" data-radio="radio_7">
            <input name="areas" class="input" value="other" required>
<!--             <span class="radio_mark"> -->
              Other
<!--             </span> -->
          </label>
